...
namespace ACG.Tools.Runtime.Pooling.Managers
{
    public class GameObjectPoolManager : PoolManagerBase
    {
        ...
        [Header("Pools")]
        private readonly List<GameObjectPool> _persistentGameObjectsPools = new();
        private readonly List<GameObjectPool> _sceneGameObjectsPools = new();
        private readonly List<GameObjectPool> _containerObjectsPools = new();
        ...
        private void DestroyPersistenPools()
        {
            ...
            _persistentGameObjectsPools.Clear();
