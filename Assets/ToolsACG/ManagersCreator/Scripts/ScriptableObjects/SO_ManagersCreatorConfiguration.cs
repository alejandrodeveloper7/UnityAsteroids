...
namespace ToolsACG.ManagersCreator.ScriptableObjects
{
    ...
    public class SO_ManagersCreatorConfiguration : ScriptableObject
    {
        ...
        [Header("Paths")]
        public string TemplatesPath = "ToolsACG/ManagersCreator/Editor/Templates/";
        public string OutputPath = "Scripts/Core/Managers";
        [Space]
        public string PrefabsPath = "Resources/Managers/";
